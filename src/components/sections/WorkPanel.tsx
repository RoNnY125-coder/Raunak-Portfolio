...
const STATIC_REPOS: Repo[] = [
    {
      id: 1200000001,
      name: "Nudge",
      description: "A calm wellness check-in app designed to track emotional well-being, daily reflections, and mindfulness with a serene aesthetic.",
      language: "TypeScript",
      html_url: "https://github.com/RoNnY125-coder/Nudge",
      stargazers_count: 1,
      homepage: "https://nudge-six-opal.vercel.app/",
      previewImage: "/work/nudge.png",
      previewPosition: "center",
    },
    {
      id: 1200000002,
      name: "Overclock",
      description: "A gamified personal finance management system featuring Athena AI, active quests, vaults, XP leveling, and smart budget insights.",
      language: "TypeScript",
      html_url: "https://github.com/NAM-tiw-am/Team-NyX---Moksh-berawala",
      stargazers_count: 1,
      homepage: "https://overclock-9.vercel.app/",
      previewImage: "/work/overclock.png",
    ...
    },
    {
      id: 1205102130,
      name: "Matdan-AI",
      description: "A civic education guide that explains India's election process with an AI-assisted chat flow and a polished democracy-focused interface.",
      language: "JavaScript",
      html_url: "https://github.com/RoNnY125-coder/Matdan-Ai",
      stargazers_count: 0,
      homepage: "https://matdan.vercel.app",
      previewImage: "/work/matdan-ai.png",
      previewPosition: "center top",
    },
    {
      id: 1205102108,
      name: "StackAudit",
      description: "A clean AI subscription audit tool that helps founders spot overlapping tools, wasted spend, and smarter stack decisions in minutes.",
      language: "TypeScript",
      html_url: "https://github.com/RoNnY125-coder/StackAudit",
      stargazers_count: 0,
      homepage: "https://stack-audit-ashy.vercel.app",
      previewImage: "/work/stack-audit.png",
      previewPosition: "center top",
    }
];
...
export const WorkPanel: React.FC<WorkPanelProps> = ({ onNavigate }) => {
  ...
  return (
    <section ref={sectionRef} className="scroll-panel w-screen h-screen flex-shrink-0 overflow-y-auto bg-[#181212]" style={{ scrollbarWidth: 'thin', scrollbarColor: '#8D1515 #181212' }}>
